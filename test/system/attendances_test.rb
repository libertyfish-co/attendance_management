...
class AttendancesTest < ApplicationSystemTestCase
  ...
  test "creating a Attendance" do
    ...
    fill_in "Corporation", with: @attendance.corporation_id
    fill_in "Employee", with: @attendance.employee_id
    fill_in "End time", with: @attendance.end_time
    fill_in "Rest time", with: @attendance.rest_time
    fill_in "Start time", with: @attendance.start_time
    fill_in "Work content", with: @attendance.work_content
