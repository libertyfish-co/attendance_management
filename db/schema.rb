...
ActiveRecord::Schema.define(version: 2022_06_08_074956) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["corporation_id"], name: "index_attendances_on_corporation_id"
  ...
  create_table "defpartments", force: :cascade do |t|
    t.bigint "corporation_id", null: false
    t.string "name"
    t.string "code"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["corporation_id"], name: "index_defpartments_on_corporation_id"
  end
  ...
  add_foreign_key "attendances", "corporations"
  add_foreign_key "attendances", "employees"
  add_foreign_key "business_calendars", "corporations"
  add_foreign_key "defpartments", "corporations"
